                    ...
                    <div class="card-body no-padding height-12">
                        <div class="row text-center m-t-10">
                            ...
                            <div class="tab setup-1 col-md-12">
                                ...
                                <p><span>Hello <?php echo $patient_first_name.' '.$patient_last_name; ?></span>, I am the MHA Tech Bot here to help you get set up for your online video consultation with Tunza clinic doktari. I will guide you through some steps to ensure you are ready to go for your online consultation.</p>
                            ...
                            <div class="tab setup-2 col-md-12">
                                ...
                                <button id="allowPermissions" class="setup-button">Allow Camera &amp; Microphone</button>
                                <div class="step-buttons">
                                    <button type="button" id="prevBtn" class="prevBtn">Previous</button>
                            ...
                            <div class="tab">
                                ...
                                <p><i>Tip: if nothing happens, try using another microphone. For example, if you are using your headphones,
                                        try removing the headphones & speak into the device. Or try using headphones if you are not using them.</i></p>
                                <div class="step-buttons">
                                    <button type="button" id="prevBtn" class="prevBtn">Previous</button>
                                    <button type="button" id="nextBtn" class="mic nextBtn">I Can See The Bars Move</button>
                                </div>
                            </div>
                            <div class="tab">
                            ...
                            <div class="tab">
                                ...
                                <div class="step-buttons">
                                    <button type="button" id="prevBtn" class="prevBtn">Previous</button>
                                    <a href="patient-waiting-room"><button type="button">Look's Good, Connect Me To Doktari Now</button></a>
                                </div>
                            </div>
                            <!-- Step indicators -->
