                    ...
                    <div class="card-body no-padding height-12">
                        <div class="row text-center m-t-10">
                            ...
                            <div class="tab">
                                ...
                                <p style="margin: 1em;"><i>Tip: if nothing happens, try using another microphone. For example, if you are using your headphones,
                            ...
                            <div class="tab">
                                ...
                                <div class="step-buttons">
                                    <button type="button" id="prevBtn" class="prevBtn">Previous</button>
                                    <a href="patient-waiting-room"><button type="button">Look's Good, Connect Me To Daktari Now</button></a>
                                </div>
                            </div>
                            <!-- Step indicators -->
