<div class="col-md-12">
    <div class="booking-step col-md-12">
        <label>
            <input type="radio" id="appointment" name="radio-button" checked onclick="return false"/>
        ...
        <label>
            <input type="radio" id="confirm" name="radio-button" onclick="return false"/>
            ...
            <div class="row md-col">
                <div class="patient-details input-group col-12 col-md-8">
                    ...
                    <div class="col-12 col-md-6 mt-i">
                        ...
                        <div id="email-error" class="col-12 col-md-12 alert alert-danger" style="display: none;"></div>
                    </div>
                    <div class="col-12 col-md-6 mt-i">
                        ...
                        <div id="gender-error" class="col-12 col-md-12 alert alert-danger" style="display: none;"></div>
                    </div>
                    <div class="col-12 col-md-6 mt-i">
                        <label>Phone number<span class="required"> * </span></label>
                        <input type="text" id="phone" name="phone" class="form-control" placeholder="Phone number" required />
                        <div id="phone-error" class="col-12 col-md-12 alert alert-danger" style="display: none;"></div>
                    </div>
                    <div class="col-12 col-md-6 mt-i">
                        <label>Date of birth<span class="required"> * </span></label>
                        <input type="text" id="dob" name="dob" class="form-control" placeholder="Date of birth" required />
                        <div id="dob-error" class="col-12 col-md-12 alert alert-danger" style="display: none;"></div>
                    </div>
                    <div class="col-12 col-md-6 mt-i">
                        ...
                        <div id="location-error" class="col-12 col-md-12 alert alert-danger" style="display: none;"></div>
                    </div>
                </div>
