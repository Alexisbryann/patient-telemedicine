 <div class="modal fade show" id="callback" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content waiting">
            ...
            <div class="modal-body"> 
                <h5 style="margin: auto;">Your Waiting Time Is <span class="time">5:00min</span></h5>
                <p id="permission-body">Apologies for waiting too long, all our doctors are currently busy. Please select one of the options below to either request a call back or reschedule your consultation.</p>
                <div id="callback-error" class="alert alert-danger"></div>
            </div>
            <div class="modal-footer">
                <button id="request-callback">Request Call Back</button>
