        ...
        <fieldset style="text-align:left;">
            <div class="input-group">
                <div class="col-12 col-md-12">
                    ...
                    <input type="text" id="medication" name="medication" class="form-control" placeholder="Are you currently taking any prescribed medication?" style="display: none;"/>
                </div>
        ...
        <fieldset style="text-align:left;">
            <div class="input-group">
                <div class="col-12 col-md-12">
                    ...
                    <input type="text" id="allergies" name="allergies" class="form-control" placeholder="Please describe your allergies" style="display: none;" />
